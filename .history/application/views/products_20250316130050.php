<div class="container mt-5">
    <div class="d-flex flex-wrap mb-4 gap-3">
        <!-- Heading on the left, ocupă 60% pe desktop și tabletă, 100% pe mobile -->
        <div class="col-12 col-md-7 d-flex align-items-center border p-3 rounded">
            <h2 class="mb-0">Products List</h2>
        </div>

        <!-- Formul, ocupă 40% pe desktop și tabletă, 100% pe mobile -->
        <div class="col-12 col-md-5 border p-3 rounded">
