												...
												<?php foreach ($permissions as $perm): ?>
													<div class="mb-3">
														<label for="<?= $perm->name; ?>" class="form-label">
															<?php if ($perm->name === 'add_product') : ?>
																<input type="checkbox" class="form-check-input" id="<?= $perm->name; ?>" name="permissions[]" value="<?= $perm->name; ?>">
															<?php elseif ($perm->name == 'edit_product') : ?>
																echo 'Edit Product';
															<?php elseif ($perm->name == 'delete_product') : ?>
																echo 'Delete Product';
															<?php endif; ?>
														</label>
													</div>
