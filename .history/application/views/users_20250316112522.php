<div class="container mt-5">
    ...
    <?php
    // Extragem doar id-urile permisiunilor deja atribuite utilizatorului curent
    $assigned_permissions = array_column($view_permissions, 'permission_id');
    ?>
    ...
    <?php foreach ($permissions as $perm): ?>
        <div class="mb-3">
            ...
            <input type="checkbox" class="form-check-input" id="<?= $perm->name; ?>" name="permissions[]" value="<?= $perm->id; ?>"
                <?php if (in_array($perm->id, $assigned_permissions)): ?> checked <?php endif; ?>>
