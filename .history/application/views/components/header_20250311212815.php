	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse d-lg-flex justify-content-center align-items-center" id="navbarSupportedContent">
			<ul class="navbar-nav mb-2 mb-lg-0">
				...
				<li class="nav-item">
					<a class="nav-link" aria-current="page" href="<?= base_url('index.php/view-users'); ?>">Users</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" aria-current="page" href="<?= base_url('index.php/view-products'); ?>">Manage Products</a>
				</li>
