	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse d-lg-flex justify-content-center align-items-center" id="navbarSupportedContent">
			<ul class="navbar-nav mb-2 mb-lg-0">
				<li class="nav-item">
					<a class="nav-link text-white" aria-current="page" href="<?= base_url('index.php/home'); ?>">Home</a>
				</li>
				...
				<?php if ($this->session->userdata('logged_in')): ?>
					<li class="nav-item text-white">
						<a class="nav-link btn btn-danger" href="<?= base_url('index.php/logout'); ?>">Logout</a>
					</li>
				<?php endif; ?>
			</ul>
		</div>
