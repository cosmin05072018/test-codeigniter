...
<?php if (validation_errors() || $this->session->flashdata('error')): ?>
        // Dacă există erori, nu închide modalul
        var modal = new bootstrap.Modal(document.getElementById('exampleModal'), {
            keyboard: false
        });
        modal.show(); // Asigură-te că modalul este deschis

        // Dezactivează butonul de închidere
        document.getElementById('closeModalButton').setAttribute('data-bs-dismiss', ''); // Înlătură acțiunea de închidere
    <?php endif; ?>
